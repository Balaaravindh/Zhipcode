...
public class TerminosActivity extends AppCompatActivity {
    ...
    TextView second_name_rate, second_name;
    ListView listnew;
    ...
    //webview
    WebView webView;
    String url = "http://landing.zhipcode.com/terms";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Progress Bar
        barProgressDialog = ProgressDialog.show(TerminosActivity.this, "Cargando...", "Por Favor Espera...", true);
        ...
        profile_page.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TerminosActivity.this, ProfileActivity.class);
        ...
        toggleButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton arg0, boolean isChecked) {
                if (isChecked == true) {
                    ...
                    final Dialog dialog = new Dialog(TerminosActivity.this);
...
//                        single_status.setChecked(false);
        ...
        NavigationDrawerAdapter adapter = new NavigationDrawerAdapter(TerminosActivity.this, NavigationDrawer.web, NavigationDrawer.imageId);
        ...
        String userAgent = WebSettings.getDefaultUserAgent(TerminosActivity.this);
    ...
    public void initilize() {
        ...
        sessionManager = new SessionManager(TerminosActivity.this);
        user = sessionManager.getUserDetails();
    ...
    private void status_check_multi() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(TerminosActivity.this);
